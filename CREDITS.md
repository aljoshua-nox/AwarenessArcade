...
2. Identify the remaining ⚠️ art: the `office/` floor and wall tiles, the numbered `pack/`
   character sheets, and the player detective sprite. All eight portraits are resolved:
   four are Calciumtrice's pack (CC-BY 3.0), four are AI-generated by the team.
