...
| Little Bits: Office (tileset + businessman1 character; the businessman was a street pedestrian until 2026-09-24 and is no longer referenced) | `assets/art/maps/Little_Bits_Office_tileset/` | AdricCustoms — [itch.io](https://adriccustoms.itch.io/little-bits-office) | Name-your-own-price; creator states use is unrestricted ("Use it for whatever you like"). No formal license text published | ✅ identified, terms informal |
...
2. Identify the remaining ⚠️ art: the `office/` floor and wall tiles — the last ⚠️ row
   ...
   row above. All sixteen portraits are resolved: four are Calciumtrice's pack (CC-BY
   3.0), twelve are AI-generated by the team.
