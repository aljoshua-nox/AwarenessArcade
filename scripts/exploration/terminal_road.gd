...
const STREET_STOPS := [
	...
	},
	{
		...
		"body": "Wiping a keyboard with a rag.\n\"The job ad? On my board since March.\"\nHe nods at a corkboard layered with flyers.\n\"Customer service rep, no experience needed, five slots left. The kids take a photo, then come back and cash in the 'training fee' at my counter. I get my cut like any cash-in.\"\n\"Not proud of it, ha. But I can't tell which ads are real either. Nobody can.\"",
		"note": "Nobody pays to get hired. A fee before the first day of work is the product; the job is the packaging.",
		"note_color": TextStyle.COLOR_TACTIC,
		"marker": TextStyle.MARK_TACTIC,
	...
	},
	{
		...
		"body": "The cash-in counter, window half open, a fan going behind it.\n\"Ate Carmen from the canteen? Yes. She came at six in the evening, still in her apron.\"\n\"I asked three times - ma'am, are you sure? Whose account is this? She said the electric company. I told her their office is two streets from here, open until seven. She said no time - they would cut her electricity at six-thirty.\"\nThe change slides across the counter.\n\"So I sent the money. Not mine. I ask three times, then I send.\"",
		"note": "The fee was invented, and the deadline was there so she would not check. A real electric bill has an office you can walk to. Thirty minutes to pay a stranger's personal account is the whole trick.",
		"note_color": TextStyle.COLOR_TACTIC,
		"marker": TextStyle.MARK_TACTIC,
	...
	},
	{
		...
		"body": "Leaning on the site gate with an unlit cigarette.\n\"Kuya Joel? He took the call in the middle of work. We were pouring concrete - you can't stop halfway, ha.\"\n\"The caller said there was a case against him, a warrant, and a police officer would be at this gate at four o'clock to take him in. He went white. I've seen that man take a steel beam on the shoulder and keep going. He went white.\"\nThe cigarette goes behind his ear.\n\"He walked out to the road for twenty minutes. Came back, finished the job like nothing happened. Didn't talk to anybody for a week.\"",
		"note": "The threat was aimed at what a man cannot afford to lose - not the money, but a day's work. The caller knew that before dialing.",
		"note_color": TextStyle.COLOR_TACTIC,
		"marker": TextStyle.MARK_TACTIC,
	...
	},
	{
		...
		"body": "Watering plants next to the pink house. She lowers her voice.\n\"The Lim girl? Trish? Paid for a job that didn't exist. Everyone on this street knows. Nobody says it in front of her mother.\"\nShe shrugs, not unkindly.\n\"My nephew almost did the same last year. Same ad. He just didn't have the two thousand pesos.\"",
		"note": "Being too broke to pay is not the same as seeing through it. The ones who could pay are the ones who go quiet.",
