...
const STREET_STOPS := [
	...
	},
	{
		...
		"body": "A half-open window, a fan going behind it.\n\"Ate Carmen from the canteen? Yes. Six o'clock, still in her apron.\"\n\"I asked three times - ma'am, whose account is this? She said the electric company. I said their office is two streets away, open till seven. She said no time, they cut the line at six-thirty.\"\nThe change slides across the counter.\n\"So I sent it. Not my money. I ask three times, then I send.\"",
		"note": "The fee is invented and the deadline is there so nobody checks. A real bill has an office. Thirty minutes to a personal account is the whole trick.",
		"note_color": TextStyle.COLOR_TACTIC,
		"marker": TextStyle.MARK_TACTIC,
	...
	},
	{
		...
		"body": "Leaning on the gatepost with an unlit cigarette.\n\"Kuya Joel? He took a call in the middle of a pour. Middle of it, ha.\"\n\"Case number, warrant, an officer at the gate at four. He went white. I've seen that man take a beam on the shoulder and keep going. He went white.\"\nThe cigarette goes behind his ear.\n\"Twenty minutes out on the road. Came back, finished the pour like nothing. Didn't talk to anybody for a week.\"",
		"note": "Fear aimed at what a man cannot afford to lose - not the money, the day's work. The script knew that before it dialed.",
		"note_color": TextStyle.COLOR_TACTIC,
		"marker": TextStyle.MARK_TACTIC,
	...
	},
	{
		...
		"body": "Watering plants next to the pink house. She lowers her voice.\n\"The Lim girl? Trish? Paid for a job that didn't exist. Everyone on this row knows. Nobody says it in front of her mother.\"\nShe shrugs, not unkindly.\n\"My nephew almost did the same last year. Same ad. He just didn't have the two thousand.\"",
